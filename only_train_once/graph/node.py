...
class Node:
    def __init__(self, id=None, op_name="", op=None, op_leaf=None, inputs=[], outputs=[], param_names=[], output_shape=[]):
        super().__init__()
        self.id = id   
    ...
    def is_stem(self):
        if self.op is not None:
            if self.op.is_basic:
                ...
                return self.is_conv() or self.is_convtranspose() or self.is_linear() or self.is_qlinear()
        else:
            return False
